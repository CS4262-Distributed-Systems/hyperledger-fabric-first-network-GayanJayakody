...
public final class AssetTransfer implements ContractInterface {
     ...
     * @param assetID the ID of the asset being duplicated
      * @param newAssetID the ID of the asset duplicated
     * @param owner new owner 
     * @return duplicated trasnsaction asset
     */
    @Transaction(intent = Transaction.TYPE.EVALUATE)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newAssetID, final String owner) {
        ...
        Asset asset = genson.deserialize(assetJSON, Asset.class);
        Asset duplicatedAsset = new Asset(newAssetID, asset.getColor(), asset.getSize(), owner, asset.getAppraisedValue());
        String sortedJson = genson.serialize(duplicatedAsset);
        stub.putStringState(duplicatedAsset.getAssetID(), sortedJson);
